...
set :server_name, %w{ec2-23-22-63-13.compute-1.amazonaws.com}
...
role :all, fetch(:server_name) # This doesn't work completely yet, hence the above 3 


set :ssh_options, {
    user: %{ubuntu},                # The user we want to log in as
    keys: %w{/cs/student/tianjiu/Downloads/face1.pem}, # Your .pem file
