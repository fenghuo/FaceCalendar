...
INSERT INTO `event` VALUES (1,1,'2013-10-23 00:00:00','2013-10-24 00:00:00','none','havefun',NULL,NULL,NULL),(2,3,'2013-10-31 00:00:00','2013-10-31 23:00:00','week','halloween!',NULL,NULL,NULL),(7,3,'2013-11-01 00:00:00','2013-11-01 00:00:00','none','','','',-1),(8,3,'2013-11-01 00:00:00','2013-11-01 00:00:00','none','','','',-1),(9,3,'2013-11-01 00:00:00','2013-11-01 00:00:00','none','','','',-1),(13,3,'2013-11-01 00:00:00','2013-11-01 00:00:00','none','xxxx','xxx','xxxx',-1),(14,3,'2013-11-01 00:00:00','2013-11-01 00:00:00','none','','','',-1);
...
INSERT INTO `groupevent` VALUES (1,3,2,'halloween'),(2,2,7,NULL),(3,2,8,NULL),(4,2,9,NULL);
...
INSERT INTO `groups` VALUES (1,'group1','1',NULL,NULL),(2,'group2','2',NULL,NULL),(3,'group3','a','a',NULL),(4,'group3','b','b',NULL),(5,'UCSB CS','2','For csil',NULL),(6,'UCSB CS','2','For csil',NULL),(7,'UCSB CS','2','For csil',NULL),(8,'UCSB CS','2','For csil',NULL);
...
INSERT INTO `user` VALUES (1,'user1','male','test@test.com','test','test.com',NULL),(2,'user2','female','test@dd.com','nn','nnn',NULL),(3,'user3','unknown',NULL,NULL,NULL,NULL);
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `groups_AddMember`(in gid int, in uid int,in descption varchar(1000),out ack bool)
BEGIN
	set ack=false;
	start transaction;
...
-- Dump completed on 2013-11-03 23:15:39
